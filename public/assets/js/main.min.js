...
$.extend($.easing, {
            ...
            init: function() {
                ...
                Wolmart.call(Wolmart.ratingTooltip, 500), Wolmart.call(Wolmart.setProgressBar(".progress-bar"), 500), this.initVariation(), this.initProductsScrollLoad(".scroll-load"), Wolmart.$body.on("mousedown", ".select-menu", (function(e) {
                    ...
                    function() {
                        ...
                        a.length || document.body.classList.contains("docs") || (t(".page-wrapper").append('<div class="compare-popup">                    <div class="container">                        <div class="compare-title">                            <h4 class="title title-center">Compare Products</h4>                        </div>                        <ul class="compare-product-list list-style-none">                            <li></li><li></li><li></li><li></li>                        </ul>                        <a href="#" class="btn btn-clean">Clean All</a>                        <a href="compare" class="btn btn-dark btn-rounded">Start Compare !</a>                    </div>                </div>                <div class="compare-popup-overlay">                </div>'), a = t(".page-wrapper > .compare-popup")), Wolmart.$body.on("click", ".product .btn-compare", (function(o) {
                            var s = t(this);
                            s.hasClass("added") && returne(), o.preventDefault(), s.toggleClass("added").addClass("load-more-overlay loading"), setTimeout((function() {
                                s.removeClass("load-more-overlay loading"), s.toggleClass("w-icon-compare").toggleClass("w-icon-check-solid"), s.attr("href", "compare"), a.addClass("show")
                            }), 500);
                            var r = s.closest(".product").find("img").eq(0).attr("src");
                            i.length >= 4 && i.shift(), i.push(r), t(".compare-popup li").each((function(t) {
                                i[t] && (this.innerHTML = '<a href="product-default"><figure><img src="' + i[t] + '"/></figure></a>                                        <a href="#" class="btn btn-remove"><i class="w-icon-times-solid"></i></a>')
                            })), e = i.length, n()
        ...
        var i = function() {
            ...
            a = function(e) {
                ...
                i.hasClass("added") || (e.preventDefault(), i.addClass("load-more-overlay loading"), setTimeout((function() {
                    i.removeClass("load-more-overlay loading").toggleClass("w-icon-heart").toggleClass("w-icon-heart-full").addClass("added").attr("href", "wishlist")
                }), 500))
            },
            n = function(e) {
        ...
        function n(e) {
            ...
            if (i.hasClass("disabled")) alert("Please select some product options before adding this product to your cart.");
                ...
                if (a.length) a.fadeOut((function() {
                    ...
                    var n = '<div class="alert alert-success alert-cart-product mb-2">                                               <p class="mb-0 ls-normal">“' + i.closest(".product-single").find(".product-title").text() + '” has been added to your cart.</p>                            <a href="#" class="btn btn-link btn-close" aria-label="button"><i class="close-icon"></i></a>                            </div>';
        ...
        Wolmart.initCodePopup = function() {
            t(".box-btn.showcode span").each((function() {
                ...
                if (i.hasClass("show-code-added")) {
                    ...
                    i[0].removeChild(a), t(".code-popup #textareaCode").text(i.data("codepopup")), t(".code-copy a")('<i class="copy-icon far fa-copy"></i>Copy to Clipboard'), Wolmart.$body.on("click", ".code-copy a", (function(e) {
                        e.preventDefault(), t(".code-popup #textareaCode").trigger("select"), document.execCommand("copy"), t(this)('<i class="copy-icon far fa-copy"></i>Copied')
                    })), setTimeout((function() {
                        Wolmart.popup({
                            items: {
                                src: ".code-popup"
    ...
    function(t) {
        ...
        var i = function(t) {
            ...
            i += e.settings.displayYear ? " " + t.getFullYear() : "", e.element.find(".calendar-title")(i)
        };
        e.defaultOptions = {
